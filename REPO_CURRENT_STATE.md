...
- Date: 2026-05-28
- Current branch: `codex/t0060-api-security-observability`
- Current status: T0060 API security and observability hardening is complete locally and deployed to dev. Changes are not committed.
- Current ticket: `T0060` completed locally, not committed
- Completed tickets: `T0000`, `T0001`, `T0002`, `T0003`, `T0004`, `T0005`, `T0006`, `T0007`, `T0008`, `T0009`, `T0010`, `T0011`, `T0012`, `T0013`, `T0014`, `T0015`, `T0016`, `T0017`, `T0018`, `T0019`, `T0020`, `T0021`, `T0022`, `T0023`, `T0024`, `T0025`, `T0026`, `T0027`, `T0028`, `T0029`, `T0030`, `T0031`, `T0032`, `T0033`, `T0034`, `T0035`, `T0036`, `T0037`, `T0038`, `T0039`, `T0041`, `T0042`, `T0043`, `T0044`, `T0045`, `T0046`, `T0047`, `T0048`, `T0049`, `T0050`, `T0051`, `T0052`, `T0053`, `T0054`, `T0055`, `T0056`, `T0057`, `T0058`, `T0059`
- Recommended next step: commit/merge T0060 when approved, then start T0061 production auth/rate-limit/WAF decision or T0062 environment and cutover plan.
...
|---|---|---|---|
| `T0060` | API security and observability hardening. | Completed locally, not committed | Dev CORS is explicit, CloudWatch dashboard/alarms are deployed, API Gateway access logs are enabled, and Roller-calling Lambdas emit safe outbound API call metrics. |

## Confirmed Next Tickets

| Ticket | Goal | Notes |
|---|---|---|
| `T0061` | Production API protection decision | Decide and implement the next API protection layer for staging/live: route auth boundary, rate limiting/throttling, WAF or equivalent edge control, and guest/staff public route policy. |
| `T0062` | Environment and cutover plan | Define staging/live config, secret ownership, deployment/rollback runbook, live backfill, webhook registration, and cutover checklist before any non-dev stack is created. |
...
- Automated root validation: `npm run validate` passed on 2026-05-28 for T0060 source-of-truth updates.
...
- T0058 production-readiness audit is docs-only and made no AWS changes. T0060 added the first dev CORS/observability hardening, but the main staging/live blockers still include production environment config, production API protection, alarm notification/runbooks, SMS sandbox/consent/sender readiness, dev-token replacement, data retention, deployment rollback, and live backfill/cutover.
