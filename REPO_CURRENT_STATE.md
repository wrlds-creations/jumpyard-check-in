...
- Product/runtime state: park-test has 202 resources, migrations through `0019`, and 27 API routes. Physical lookup and P400 approval are proven. Async kiosk reconciliation is deployed; issue #239 now delays publish 10 seconds for payment settlement and uses absolute five-second readback, pending protected deployment and a second P400 timing proof. The controlled check-in alias passed Love's 2026-08-17 iPhone payment/Apple Pay test but remains park-test-backed. The T-30 control is disarmed and the general send gate is false.
