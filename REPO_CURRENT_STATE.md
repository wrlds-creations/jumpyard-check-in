...
- Date: 2026-08-10
- Latest merged product baseline: `ae63913`; PR #231 added fail-closed Nacka verification when ROLLER booking detail omits venue.
- Latest deployed product baseline: protected run `31374686605` promoted immutable release `ae63913`; only `LookupHandler` changed, with no migration and exact AWS/Cloudflare verification.
