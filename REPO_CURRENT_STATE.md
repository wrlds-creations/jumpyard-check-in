...
- Date: 2026-09-09
- Public/Park: `bad087f` ([#403](docs/gh-403-lookup-audit-permission.md)): lookup audit-ID grant; [#345](docs/gh-345-staff-handout.md): counts, collection/loading, daily codes and early café. 94 staff/30 native checks; APK 1.0.0 merged/accepted (#401, `8223843`). #353 Klarna exclusions; #340 diagnostics; #335 alarms; #374 Apple Pay accepted.
- Operations: private [Project](https://github.com/orgs/wrlds-creations/projects/5), shared across JumpYard repositories; each new item names its exact Target repository.
