...
- `DECISIONS.md` exists.
- `CODEX_TASK.md` exists and supports scoped ticket handoffs.
- `REPO_CURRENT_STATE.md` exists for current repository status.
- `FOLLOWUPS.md` exists for out-of-scope issues and deferred work.
