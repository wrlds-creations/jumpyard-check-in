...
No dependency, schema, route, permission, AWS resource or provider setting changes are needed. The unrelated #396 worktree and #389 design source remain untouched. Release must follow the existing reviewed-PR and protected immutable promotion path. The current rollback candidate is the previously deployed September 8 refinement, release `34239775713` / `653c09676201b9856d5b744d0ef716bf6a510088`; retain schema 0022, receipts and counters. Until the new promotion is recorded, the September 8 release remains live.
