...
New validation and browser evidence are recorded in the [issue runbook](../docs/gh-345-staff-handout.md#live-feedback-refinements--2026-09-08). Screenshots: local `gh345-staff-speed-20260908` folder. All browser writes use the isolated PostgreSQL fixtures; live timing queries are read-only. The initial published version/evidence above remains historical until the refined artifact is promoted.
