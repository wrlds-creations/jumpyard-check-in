...
| `FU-042` | `T0028/T0030/T0031/T0032/T0033/T0034/T0050/T0051` | Payment prerequisites | T0051 vendors and wires Roller's approved `@roller/ecom-payments` `v217` package for new-booking drafts. Pabel confirmed API authorization through API-key access, the Roller Payments docs, `paymentSettings` from `GET /venues/me`, and Adyen Visa test card ending `1142`. Remaining: public HTTPS test-domain allowlisting confirmation for `https://jumpyard-check-in.pages.dev`, a successful browser payment smoke, and reusing the payment path for add-product drafts in T0052. | High | `Pabel/T0052` | Open |
