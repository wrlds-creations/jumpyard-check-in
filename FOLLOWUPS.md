...
| `FU-042` | `T0028/T0030/T0031` | Payment prerequisites | T0030 confirmed Roller draft-booking `paymentJwt`; T0031 deployed quote/draft endpoints that return payment-session data. Remaining: obtain ROLLER authorization, approved payment package access, public HTTPS test-domain allowlisting, and fake/test card details before phone UI payment work. | High | `T0032` | Open |
