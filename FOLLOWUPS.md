...
| `FU-042` | `T0028/T0030/T0031/T0032` | Payment prerequisites | T0030 confirmed Roller draft-booking `paymentJwt`; T0031 deployed quote/draft endpoints that return payment-session data; T0032 added a safe local POC harness. Remaining: obtain ROLLER authorization, approved payment package access, public HTTPS test-domain allowlisting, and fake/test card details before payment drop-in work. T0033 may build the pre-payment booking flow without processing payments. | High | `T0034` | Open |
