...
| `FU-042` | `T0028/T0030/T0031/T0032/T0033/T0034/T0050` | Payment prerequisites | T0030 confirmed Roller draft-booking `paymentJwt`; T0031 deployed quote/draft endpoints; T0032 added the safe POC harness; T0033/T0034/T0035 stop at payment pending. Pabel confirmed API authorization through API-key access, the Roller Payments docs, `paymentSettings` from `GET /venues/me`, and Adyen Visa test card ending `1142`. Remaining: public HTTPS test-domain allowlisting confirmation for `https://jumpyard-check-in.pages.dev` and actual payment package/drop-in execution in T0051/T0052. | High | `Pabel/T0051` | Open |
