...
const sv = {
  ...
  buy: {
    ...
    noPaymentDesc: 'Presentkortet täcker hela beloppet. Vi hämtar bokningen och fortsätter check-in.',
...
const en: typeof sv = {
  ...
  buy: {
    ...
    noPaymentDesc: 'The gift card covers the full amount. We are loading the booking and continuing check-in.',
