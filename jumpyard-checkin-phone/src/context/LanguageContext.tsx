...
const sv = {
  ...
  safetyVideo: {
    ...
    buyDescription: 'Gå igenom den korta säkerheten innan ni går till entrén.',
    play: 'Spela upp',
  ...
  confirm: {
    ...
    qrHelp: 'Skanna QR-kod eller ange ditt namn till personalen.',
...
const en: typeof sv = {
  ...
  safetyVideo: {
    ...
    buyDescription: 'Complete the short safety walkthrough before heading to the entrance.',
    play: 'Play',
  ...
  confirm: {
    ...
    qrHelp: 'Scan the QR code or give your name to staff.',
