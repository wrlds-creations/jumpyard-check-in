...
const sv = {
  ...
  buy: {
    ...
    paymentReadyDesc: 'Kortbetalningen laddas för',
...
const en: typeof sv = {
  ...
  buy: {
    ...
    paymentReadyDesc: 'Card payment is loading for',
