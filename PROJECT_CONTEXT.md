...
- Live water for new phone/kiosk purchases maps only to JumpYard Vatten `970411` under Cold Drinks `970363` (#315/D0195). Its fresh 24-hour cached provider price is required; missing data never falls back to retired `1324123`. Existing paid/in-flight purchases keep their original product and total.
