...
- Guest messaging remains gated. Park-test has deployed `jumpyard.se` Easy DKIM and a disabled configuration set for `JumpYard Nacka <nackaforum@jumpyard.se>`; João-owned DNS verification is pending. SES sizing is extreme 3,000/day and 5/minute; request 5,000/day and 5/second. Guest sends and scheduling remain off.
