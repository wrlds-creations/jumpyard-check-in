  ...
  const manifest = {
    ...
    target: {
      ...
      cloudflare: {
        ...
        publicAdminProject: CONTRACT.publicAdminProject,
        publicAdminUrl: CONTRACT.publicAdminUrl,
        publicPhoneProject: CONTRACT.publicPhoneProject,
        publicPhoneUrl: CONTRACT.publicPhoneUrl,
      },
