...
Love owns first response using the acknowledgement/escalation runbook. External monitoring remains unconfirmed; the single recipient provides no backup or out-of-hours guarantee. Rollback candidate is release `33875422657` / `0e04fb4f3a86d11366687e4aa7b4cd232d1fc4ce`, artifact `9937812376`, already verified in Park run `33875994276`. No rollback, re-promotion, public-origin promotion or guest message occurred for #335. Recreating the topic requires fresh subscription confirmation. [Hashes, delivery proof and remaining operational question](docs/gh-335-park-alarm-routing.md#protected-rollout-and-delivery-proof--2026-09-04).
