...
| Status | T0150 foundation deployed; T0151 migrations through `0008` applied; T0155 Live webhook `1465` registered with processing disabled; T0156 park-test frontend target/CORS configured; Cloudflare park-test Pages projects created; T0157 guarded Live quote/cost smoke passed; T0158 guarded Live draft smoke created one controlled draft; T0159 internal paid Live booking smoke passed with draft-write gate closed again; T0160 controlled Live existing-booking lookup smoke passed with lookup gate closed again; T0161 Live catalog/index readiness passed; public API draft writes, frontend visitor traffic, Live lookup/sync, redeem, SMS, and email remain gated |
