...
| `ij4rnaui2b` | API Gateway HTTP API | `park-test` | `eu-north-1` | `cdk` | Endpoint `https://ij4rnaui2b.execute-api.eu-north-1.amazonaws.com`; routes are deployed but frontend traffic is not connected. CORS currently uses placeholder origins until T0156. |
...
| Status | T0150 foundation deployed; T0151 migrations through `0008` applied; T0155 Live webhook `1465` registered with processing disabled; frontend traffic, payment, redeem, SMS, and email remain gated |
